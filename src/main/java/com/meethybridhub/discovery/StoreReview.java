...
@Table(name = "store_reviews", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"store_id", "customer_id"})
})
@EntityListeners(AuditingEntityListener.class)
public class StoreReview extends TenantEntity {
    ...
    public StoreReview(Long storeId, User customer, short rating, String title, String comment, boolean verified) {
        setStoreId(storeId);
