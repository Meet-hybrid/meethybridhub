  ...
  if (!product) {
    return (
      ...
      <div className="text-center py-20">
          ...
          <Link href="/products" className="text-amber-600 hover:text-amber-500 text-sm mt-2 inline-block">
            ← Back to shop
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="aspect-square bg-gradient-to-br from-amber-100 to-orange-100 rounded-3xl flex items-center justify-center">
          <span className="text-8xl opacity-60">
            {activeStore.slug === "divinez-signature" && product.category?.name === "Bracelets" && "📿"}
            {activeStore.slug === "divinez-signature" && product.category?.name === "Necklaces" && "💎"}
            {activeStore.slug === "divinez-signature" && product.category?.name === "Anklets" && "🦶"}
            {activeStore.slug === "divinez-signature" && product.category?.name === "Waist Beads" && "✨"}
            {activeStore.slug === "divinez-signature" && product.category?.name === "Bags" && "👜"}
            {activeStore.slug === "divinez-signature" && product.category?.name === "Sets" && "🎁"}
            {activeStore.slug !== "divinez-signature" && "✦"}
            {!["Bracelets", "Necklaces", "Anklets", "Waist Beads", "Bags", "Sets"].includes(product.category?.name) && "📿"}
          </span>
        </div>
